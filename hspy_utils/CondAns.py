    ...
    def interactive_peak_fit_manual(self, exp_key, start_row=0, start_col=0):
        ...
        def make_peak_row():
            ...
            def make_param(name, init, lo, hi):
                ...
                column = VBox([title, hdr, HBox([val, vmin, vmax], layout=Layout(gap='1px'))],
                            layout=col_layout)
            ...
            row = HBox([amp_col, cen_col, sig_col, func, exists], layout=row_layout)
